                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-10 wow fadeIn" data-wow-delay="0.3s">
                            ...
                            <img src="/images/mock3.png" class="img-responsive" alt="home img">
                        </div>
                        <div class="col-md-1"></div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 wow fadeInUp mock-box" data-wow-delay="0.3s">
                        ...
                        <p>Mock Server is deployed on Aliyun, so can be available in 7 * 24
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-delay="0.6s">
                        ...
                        <p>Create projects as many as you need.
                        </p>
                        <p>
                            <span>
                                <i class="fa fa-mobile"></i>
                            </span>Create a project, specify the proxy, type and desc to your real backend server.</p>
                        <p>
                            <i class="fa fa-code"></i>Project is supported with two types: prefix and header parameter.</p>
                    </div>
                    <div class="col-md-6 wow fadeInRight" data-wow-delay="0.6s">
                        <img src="/images/mock1.png" class="img-responsive" alt="feature img">
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <img src="/images/mock2.png" class="img-responsive" alt="feature img">
                    </div>
                    <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                        <h2 class="text-uppercase">Mockapis</h2>
                        <p>Apis with classifications are supported</p>
                        <p>
                            <span>
                                <i class="fa fa-mobile"></i>
                            </span>Create a api, specify the result, parameters , method and all things your real request need.</p>
                        <p>
                            <i class="fa fa-code"></i>Classification will be automate generated by mockapis</p>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 wow fadeInLeft" data-wow-delay="0.6s">
                        ...
                        <button class="btn btn-primary text-uppercase" onclick="location.href='/admin'">
                            <i class="fa fa-try"></i>
                            Try</button>
                    </div>
                    <div class="col-md-6 wow fadeInRight" data-wow-delay="0.6s">
                        <img src="/images/mock3.png" class="img-responsive" alt="feature img">
                    </div>
                </div>
            </div>
        </section>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                            <div class="contact-form">
                                ...
                                <div class="col-md-6">
                                    <input type="email" class="form-control" placeholder="Email" id="c_email">
                                </div>
                                <div class="col-md-12">
                                    <input type="text" class="form-control" placeholder="Subject" id="c_message">
                                </div>
                                <div class="col-md-12">
                                    <textarea class="form-control" placeholder="Message" rows="4" id="c_text"></textarea>
                                </div>
                                <div class="ajax-response"></div>
                                <div class="col-md-8">
                                    <input type="submit" class="form-control text-uppercase sendMsg" value="Send">
                                </div>
                            </div>
                        </div>
                    </div>
